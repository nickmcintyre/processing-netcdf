...
void setup() {
  ...
  u = data.get4DFloatArray("U");
  v = data.get4DFloatArray("V");
  w = data.get4DFloatArray("W");
  ph = data.get4DFloatArray("PH");
  phb = data.get4DFloatArray("PHB");
  
  Table phInfo = data.getInfo("PH");
  int[] shape = phInfo.getIntColumn("length");
